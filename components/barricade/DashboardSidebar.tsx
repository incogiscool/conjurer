...
const DashboardSidebar = () => {
  const [walletBalanceSolRounded, setWalletBalanceSolRounded] =
    useState<number>(0);
  const [isProfileTabHovered, setIsProfileTabHovered] =
        ...
        <div className="ml-6">
          ...
          >
            <svg
              ...
              onMouseEnter={() => setIsProfileTabHovered(true)}
              onMouseLeave={() => {
                setIsProfileTabHovered(false);
              }}
            >
            ...
            <p
              className="text-white ml-6 font-medium text-lg"
              onMouseEnter={() => setIsProfileTabHovered(true)}
              onMouseLeave={() => {
                setIsProfileTabHovered(false);
              }}
            ...
            <div
              className="fixed top-48 left-28 transition 1s"
              style={{ opacity: isProfileTabHovered ? 1 : 0 }}
            >
              {isProfileTabHovered ? <ToolTip tooltip="Coming Soon!" /> : ""}
            </div>
          </div>
          <div
